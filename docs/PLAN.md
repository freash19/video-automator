...
- []  Подчинить запуск задач. Привести в рабочий режим и протестировать на одном из загруженных сценариев, добавив 3 сцены из цсв файла. В конечном итоги должны запускаться разные профили при выборе, не крашится, работать скрипт с хайгеном, запускать разные профили, не сбрасываться сессия при повторном запуске, запускаться через обычный хром или хромиум, а не через chrome for testing. 
